...
function dialogs() {
  ...
  <input id="import-input" class="visually-hidden" type="file" accept="application/json,.json" aria-label="Choose Continuity Board JSON backup" />`;
}
